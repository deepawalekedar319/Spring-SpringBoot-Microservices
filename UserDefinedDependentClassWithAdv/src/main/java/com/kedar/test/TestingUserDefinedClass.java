...
public class TestingUserDefinedClass {
	...
	public static void main(String[] args) {
       ...
       //FileSystemResource resource = new FileSystemResource("src/main/java/com/kedar/configurations/applicationContext.xml");
		//FileSystemResource resource = new FileSystemResource("E:\\Common Files and Folders\\Workspaces\\SpringBootAndMicroServices\\UserDefinedDependentClassWithAdv\\src\\main\\java\\com\\kedar\\configurations\\applicationContext.xml");
		
		// Working with ClassPathResource 
